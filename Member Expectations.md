...
- Must fill out the following:
  ...
  4. Iron Riders Roster

Failure to follow these rules will result in a conversation with Leadership and/or Coach(es). In extreme cases, failure to follow these expectations will result in a suspension by the Coach(es).

---

**No penalization for good faith efforts; we understand that this team  is time-consuming and will do our best to work with your schedule.
**These forms will be available in-person.
